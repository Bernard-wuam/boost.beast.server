...
class UpdateProfilePicturedb {
public:
  static boost::asio::awaitable<
      std::expected<boost::json::object, std::error_code>,
      boost::asio::strand<boost::asio::io_context::executor_type>>
  updateProfilePicturedb(boost::mysql::connection_pool &conn,
    ...
    if (ec) {
      std::cout << "from updating profile picture" << std::endl;
